...
csv_file_label = tk.Label(root, text="Select a JSON file:")
csv_file_label.pack()

csv_file_path = tk.Label(root, text="No JSON file selected")
csv_file_path.pack()
...
append_button = tk.Button(root, text="Append to JSON", command=append_to_json, relief=RAISED)
append_button.pack(pady=10)

deleteRow_button = tk.Button(root, text="Delete from JSON", command=delete_from_json, relief=RAISED)
